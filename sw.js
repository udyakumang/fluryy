...
const CACHE='fluryy-cache-v7';
const OFFLINE=['/','/index.html','/css/styles.css','/js/main.js','/assets/logo-fluryy.svg','/assets/favicon.svg','/providers.html','/pets.html','/dashboard.html','/login.html','/register.html','/thanks.html'];
