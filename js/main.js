...
(function(){
  ...
  function renderAuthNav(){
    ...
    const u=getUser();
    if(u){
      account.innerHTML = '<a href="/dashboard.html">Dashboard</a> <button class="btn secondary" data-logout>Logout</button>';
      account.querySelector('[data-logout]').addEventListener('click',()=>{ clearUser(); location.href='/'; });
    }else{
      account.innerHTML = '<a href="/login.html">Login</a> <a class="cta" href="/register.html">Sign up</a>';
    }
  }
